...
<head>
    ...
    <title>Download Payslip CSV</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-file-download icon"></i>Download Payslip CSV</h1>
            <p class="subtitle">Generate and download individual payslip in CSV format</p>
        </div>
        ...
        <div class="form-card">
            <form method="POST">
                ...
                <button type="submit"><i class="fas fa-download icon"></i>Download CSV</button>
            </form>
        </div>
